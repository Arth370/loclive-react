      ...
      <main>
        <section id='secao-1'>
          <div id='left-side'>
            ...
            <p className='text-secao1'>
              Deseja adquirir <span style={{color:'#FFB70E'}}>produtos eletrônicos</span> mas não sabe<br/>
              o melhor lugar para encontrá-los?  A <span style={{color:'#FFB70E'}}>LocLive</span> te ajuda<br/>
              à encontrar o <span style={{color:'#FFB70E'}}>produto</span> adequado e dentro de<br/>
              seu orçamento escolhido.
            </p>
            <Link to="/sobre" id='SaibaMais'>Saiba Mais</Link>
          </div>
